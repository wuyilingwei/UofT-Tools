...
from common.http import CALENDAR_BOT_UA, make_session
...
OUTPUT_FILE = CALENDAR_DIR / "utsc.ics"
...
def _http_session() -> requests.Session:
    return make_session(CALENDAR_BOT_UA)
...
def generate_ics(events: list[dict], output_path: Path) -> None:
    ...
    write_all_day_calendar(
        events,
        output_path,
        prodid="-//U-of-T-Calendar-Bot//UTSC Important Dates//EN",
        calname="UTSC Important Dates",
        uid_domain="utsc-calendar-bot.github.io",
        source_url=UTSC_HUB_URL,
    )
